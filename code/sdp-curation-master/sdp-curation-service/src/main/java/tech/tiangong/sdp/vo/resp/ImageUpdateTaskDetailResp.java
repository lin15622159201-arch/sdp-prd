...
@Data
public class ImageUpdateTaskDetailResp extends BasicVO {
    @Serial
    ...
    public static class Skc implements Serializable {
         ...
         * 当前已选图片
         */
        private List<ImageUpdatePictureResp> currentPictures;

        /**
         * 更新内容图片信息
         */
        private List<ImageUpdateResultResp> updatePictures;
