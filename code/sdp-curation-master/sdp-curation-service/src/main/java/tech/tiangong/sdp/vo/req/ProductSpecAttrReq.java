 ...
 */
@Data
public class ProductSpecAttrReq implements Serializable {
    @Serial
    private static final long serialVersionUID = 7394778212807496541L;
    /**
     * 主键 id
     */
    private Long attrId;
    ...
    public boolean add() {
        return Objects.isNull(this.attrId) || this.attrId <1 ;
    }
}
