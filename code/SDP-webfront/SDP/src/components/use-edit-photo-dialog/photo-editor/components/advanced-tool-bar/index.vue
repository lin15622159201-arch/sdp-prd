<template>
  ...
  <div class="tw-bg-white tw-px-[7px] tw-mr-[1px]">
    ...
    <!-- <IconfontButton
      ...
      :active="toolbarStore.activeTool === TOOL_ENUM.UN_WATERMARK"
      @click="toolbarStore.activeTool = TOOL_ENUM.UN_WATERMARK"
      text="消除水印"
    />
    <icon-button
  ...
  <div class="tw-w-[256px] tw-bg-white tw-p-[14px] tw-mr-[1px] tw-relative" v-show="toolbarStore.activeTool">
    ...
    <rect-config-panel v-if="toolbarStore.activeTool === TOOL_ENUM.UN_WATERMARK" />
