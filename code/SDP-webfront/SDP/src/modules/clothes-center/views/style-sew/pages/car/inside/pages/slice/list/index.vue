  ...
  <sc-app-page :laside="laside">
    ...
    <template #header>
      <div class="tw-flex tw-mb[10px]">
        <el-button
          type="danger"
          v-if="params.clothesStepNodeState === SAMPLE_DEVELOP_STEP_STATE_ENMU.WORKING && YCFQ"
...
import { ref, computed, watch, reactive, PropType, toRefs, onMounted } from 'vue';
...
const handleParamsData = (customParams: any) => {
  ...
  const row = tabs.value.find(v => v.value === rest.clothesStepNodeState)!.params;
  const timeParams = {
