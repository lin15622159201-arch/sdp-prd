...
const { searchConfig } = useSearch({ mode: 'cut' });
...
const handleParamsData = (custom: any) => {
  ...
  rest.cutFinishTimeStart = rest.finishTimeStart || '';
  rest.cutFinishTimeEnd = rest.finishTimeEnd || '';
  rest.allocateFinishTimeStart = rest.createdTimeStart || '';
  rest.allocateFinishTimeEnd = rest.createdTimeEnd || '';
