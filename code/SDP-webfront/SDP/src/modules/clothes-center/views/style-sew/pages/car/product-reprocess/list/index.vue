<template>
  <sc-app-page :laside="laside">
    ...
    <template #header>
      <div class="tw-flex tw-mb[10px]" v-if="activeTab === TABS_ENUM.DOING && YCFQ">
        <el-button
          type="danger"
...
import { sewQueryByPage } from '../../../../api/index';
import {
...
const {
  ...
  request: {
    ...
    params: {
      ...
      sewerIdList: [],
      cutterIdList: [],
      finishCraftCreatedTimeStart: '',
      finishCraftCreatedTimeEnd: '',
      finishCraftFinishTimeStart: '',
      finishCraftFinishTimeEnd: '',
      timeConsumingStart: '',
      timeConsumingEnd: '',
