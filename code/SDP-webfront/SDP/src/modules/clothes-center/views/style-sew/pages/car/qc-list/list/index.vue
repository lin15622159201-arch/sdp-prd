<template>
  <sc-app-page :laside="laside">
    ...
    <error-dialog
      ...
      :launch-buz-id="selectedList[0]?.sampleQcId"
      :clothes-step="CLOTHES_STEP_ENUM.QC"
      @success="init()"
    />
  </sc-app-page>
</template>
...
import { sampleQcPage } from '../../../../api/index';
import {
...
import { ISampleQcPageResListItem } from '@/modules/clothes-center/views/style-sew/api/types';
...
const selectedList = ref<ISampleQcPageResListItem[]>([]);
const handleSelectionChange = (rows: ISampleQcPageResListItem[]) => {
...
/* remark */
useTableDataMapRemark<ISampleQcPageResListItem>(
  tableData,
  'clothesId',
