<template>
  <sc-app-page :laside="laside">
    ...
    <error-dialog
      ...
      :launch-buz-id="selectedLst[0]?.sewId"
...
const { searchConfig } = useSearch({ mode: 'slice' });
...
const handleParamsData = (custom: any) => {
  ...
  rest.sliceCraftFinishTimeStart = rest.finishTimeStart || '';
  rest.sliceCraftFinishTimeEnd = rest.finishTimeEnd || '';
  rest.sliceCraftCreatedTimeStart = rest.createdTimeStart || '';
  rest.cutCreatedTimeEnd = rest.createdTimeEnd || '';
...
const {
  ...
  request: {
    ...
    params: {
      ...
      sewerIdList: [],
      cutterIdList: [],
      sliceCraftCreatedTimeStart: '',
      sliceCraftCreatedTimeEnd: '',
      sliceCraftFinishTimeStart: '',
      sliceCraftFinishTimeEnd: '',
      finishTimeStart: '',
      finishTimeEnd: '',
      createdTimeStart: '',
      createdTimeEnd: '',
...
const selectedLst = ref<ISewQueryByPageResListItem[]>([]);
