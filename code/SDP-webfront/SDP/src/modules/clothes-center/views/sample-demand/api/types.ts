...
/**
 * 打版需求汇总-状态统计
 * yapi地址：https://yapi.tiangong.site/project/38/interface/api/2477
 */

export type IStateCountRes = IStateCountResItem[];
export interface IStateCountResItem {
  /**
   * 状态
   */
  state?: STATE_ENUM;
...
/**
 * 打版需求汇总-分页查询
 * yapi地址：https://yapi.tiangong.site/project/38/interface/api/2478
 */
export interface IRequirementSummaryPageReq {
  /**
   * 首版创建时间结束
   */
   ...
   * 样衣所在处理环节code （参考 ClothesStepEnum）
   */
  clothesStepList?: Array<PROCESS_STEP_CODE_ENUM | ''>;
  /**
...
export interface IRequirementSummaryPageRes {
  page?: number;
  total?: number;
  list: IRequirementSummaryPageResListItem[];
}

export interface IRequirementSummaryPageResListItem {
  /**
   * 版单id
   */
  clothesId?: string;
   ...
   * 二次工艺
   */
  craftList: IRequirementSummaryPageResListItemCraftListItem[];
  /**
   * 裁剪方法
   */
   ...
   * 异常信息
   */
  anomaly?: IRequirementSummaryPageResListItemAnomaly;
  /**
   * 返修信息
   */
  repair?: IRequirementSummaryPageResListItemRepair;
  /**
   * 复版信息
   */
  redoInfo?: IRequirementSummaryPageResListItemRedoInfo;
  /**
   * 是否取消 0-否、1-是
   */
   ...
   * 样衣版单各环节节点状态描述
   */
  nodeStates: IRequirementSummaryPageResListItemNodeStatesItem[];
  remark?: string;
  /**
   * 创建时间
   */
   ...
   * 加工单合审版通过时间
   */
  auditPassTime?: number;
  /**
   * 首版创建时间(同一个base_process_code，但版号是1的打版任务创建时间)
   */
...
export interface IRequirementSummaryPageResListItemNodeStatesItem {
  /**
   * 样衣打版id
   */
  clothesId?: string;
...
export interface IRequirementSummaryPageResListItemRedoInfo {
  /**
   * 样衣打版id
   */
  clothesId?: string;
...
export interface IRequirementSummaryPageResListItemRepair {
  /**
   * 样衣打版id
   */
  clothesId?: string;
...
export interface IRequirementSummaryPageResListItemAnomaly {
  /**
   * 样衣打版id
   */
  clothesId?: string;
...
export interface IRequirementSummaryPageResListItemCraftListItem {
  /**
...
/**
 * 打版需求汇总-获取编辑内容
 * yapi地址：https://yapi.tiangong.site/project/38/interface/api/2479
 */
export interface IRequirementSummaryOpenEditReq {
  sampleClothesId: string;
}

export interface IRequirementSummaryOpenEditRes {
  /**
   * 版次，默认为sample_type的描述1-大货打版 2-正常打版 3-复色打版 4-补做打版
   * 如果是补做打版，需要加上补做打版的次数，如：补做打版2
   */
  sampleTimes?: string;
  /**
   * SKC
  ...
  sampleClothesId?: string;
  /**
   * 打版方式0-仅纸样 1-实物样 2-3D样
   */
  makeClothesTypes: IRequirementSummaryOpenEditResMakeClothesTypesItem[];
  /**
   * 样衣尺码
   */
  sampleSize?: string;
  ...
  sizeStandardCode: string;
  /**
   * 是否允许修改尺样衣码 0-不允许，1-允许
   */
  allowChangeSampleSize?: string;
  /**
   * 是否允许修改样衣数量 0-不允许，1-允许
   */
  allowChangeSampleAmount?: string;
}

export interface IRequirementSummaryOpenEditResMakeClothesTypesItem {
  code?: string;
  name?: string;
}
...
/**
 * 打版需求汇总-编辑需求
 * yapi地址：https://yapi.tiangong.site/project/38/interface/api/2480
 */
export interface IRequirementSummaryEditReq {
  /**
   * 样衣版单ID
   */
  sampleClothesId: string;
...
/**
 * 取消打版需求汇总
 * yapi地址：https://yapi.tiangong.site/project/38/interface/api/3661
 */
export interface IRequirementSummaryCancelSampleClothesReq {
  /**
   * 样衣版单ID
   */
...
export type IRequirementSummaryStepCountRes = {
  [key in PROCESS_STEP_CODE_ENUM]: number;
};
